...
public class Program
{
    static async Task Main()
    {
        ...
        var prompt = $"""
You are an expert C# developer. Write a complete public xUnit test class in C# that tests all public methods of the following class.

Requirements:
- Use xUnit only. No Moq.
- Include [Fact] or [Theory] attributes.
- Test both valid inputs and exceptions if any.
- The output must be ONLY a single C# code file. No explanations, no markdown, no file names.
